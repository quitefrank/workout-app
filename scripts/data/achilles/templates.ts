 ...
 *
 * Order inside each template: the floor block first (every row with
 * floorTransferRequired, which now includes the cable floor sits at the
 * towers), then the rest in the review's order. One transfer down, one
 * transfer up.
 *
...
export const TEMPLATES: TemplateSeed[] = [
  {
    ...
    variant: null,
    notes:
      "The recovery programme's leg session in the boot. Floor block first: the article's non-weight-bearing and core work on the mat, then the bench, the rack and the wall. Three rows load the booted foot at the cleared percentage and record a rule 1 override, which is why this template starts at phase 2. The sound-leg calf raises are the highest-value items of the week: cross-education against the primary long-term deficit.",
    spacingNote: null,
    phases: [2, 3, 4, 5, 6, 7],
    exercises: [
      {
  ...
  },
  {
    ...
    variant: null,
    notes:
      "The recovery programme's push session in the boot. Floor block first: the supine triceps extension, the front plank and the cable fly from the mat at the towers, then the bench. Nothing loads the booted foot.",
    spacingNote: null,
  ...
  },
  {
    ...
    variant: null,
    notes:
      "The recovery programme's pull session in the boot. Floor block first: the Russian twist, the cable row and the face pull from the mat at the towers, then the bar and the bench. Pull-ups are capped at two sessions a week, 72 hours apart, and this is the only template that carries them, so it runs at most twice a week with the second run at the light dose: 3 x leave 2-3 in reserve on the pull-ups and lighter curls.",
    spacingNote: null,
    phases: [1, 2, 3, 4, 5, 6, 7],
    exercises: [
      {
      ...
      },
      {
        ...
        dose: "3 x 10-15",
        cue: "Knees bent. Only worth it if you are already at the bar. Zero foot contact, controlled, no swing",
        override: null,
      },
      {
        slug: "db-curls",
