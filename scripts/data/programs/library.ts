...
export const LIBRARY_ATTRIBUTES: Record<string, LibraryAttributes> = {
  ...
  "eccentric-dip": { muscleGroup: "Triceps", equipmentType: "bodyweight" },
  "eccentric-goblet-squat": { muscleGroup: "Quadriceps", equipmentType: "other" },
  ...
  "tempo-back-squat": { muscleGroup: "Quadriceps", equipmentType: "barbell" },
  "tempo-standing-calf-raise": { muscleGroup: "Calves", equipmentType: "other" },
