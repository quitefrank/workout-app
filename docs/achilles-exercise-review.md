...
> Updated [2026-09-16]: the floor-first order was overruled. Frank: "Forget about this going-from-the-floor-up-and-down transfer. Being injury-prone, it's getting off the bench and on the bench, or off the floor and on the bench, that has injury potential. I want it to be muscle-dependent, not injury-prevention-first." All three templates now run biggest compound first, isolation after, core last. Pull: pull-ups, cable row, face pull, curls, hanging leg raise, Russian twists. Push: DB bench, shoulder press, modified push-ups, cable fly, lateral raise, supine triceps extension, front plank, suitcase hold. Legs: sit to stand, wall squats, glute bridges, single-leg calf raise, seated calf raise, band leg extensions, hip abductions, straight leg raises, supine marches. The row lists below keep the original order as rated; the seed in `scripts/data/achilles/templates.ts` is the source of truth for order.
